                ...
                <div className="mt-8 space-y-8 md:-mx-4 md:flex md:items-center md:justify-center md:space-y-0 xl:mt-0">
                    <div className="max-w-sm mx-auto border rounded-lg md:mx-4 dark:border-gray-700">
                        <div className="p-6">
                            ...
                            <p className="mt-4 text-gray-500 dark:text-gray-300">
                                Essential plan covers getting a reume analysis and further chat suppport from out AI limited to 13000 tokens
                            </p>

                            <h2 className="mt-4 text-2xl font-semibold text-gray-700 sm:text-3xl dark:text-gray-300">$4.99 <span className="text-base font-medium">/Month</span></h2>
                        ...
                        <div className="p-6">
                            ...
                            <div className="mt-8 space-y-4">
                                <div className="flex items-center">
                                    ...
                                    <span className="mx-4 text-gray-700 dark:text-gray-300">Standard Analysis</span>
                                </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <span className="mx-4 text-gray-700 dark:text-gray-300">25 point Analytics</span>
                                </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <span className="mx-4 text-gray-700 dark:text-gray-300">Chat support ~ limited</span>
                                </div>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-red-400" viewBox="0 0 20 20" fill="currentColor">
                                    ...
                                    <span className="mx-4 text-gray-700 dark:text-gray-300">Career Guide</span>
                                </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <span className="mx-4 text-gray-700 dark:text-gray-300">12 Resume Analysis</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-sm mx-auto border rounded-lg md:mx-4 dark:border-gray-700">
                        <div className="p-6">
                            ...
                            <p className="mt-4 text-gray-500 dark:text-gray-300">
                            Essential plan covers getting a reume analysis and further chat suppport from out AI limited to 33000 tokens and further pay-as-you-go at $0.06 per 1000 tokens.
                            </p>

                            <h2 className="mt-4 text-2xl font-semibold text-gray-700 sm:text-3xl dark:text-gray-300">$19.99 <span className="text-base font-medium">/Month</span></h2>
                        ...
                        <div className="p-6">
                            ...
                            <div className="mt-8 space-y-4">
                                <div className="flex items-center">
                                    ...
                                    <span className="mx-4 text-gray-700 dark:text-gray-300">Indepth Analysis</span>
                                </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <span className="mx-4 text-gray-700 dark:text-gray-300">~99% word analyzing</span>
                                </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <span className="mx-4 text-gray-700 dark:text-gray-300">Chat support ~ unlimited</span>
                                </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <span className="mx-4 text-gray-700 dark:text-gray-300">Mobile app(soon)</span>
                                </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <span className="mx-4 text-gray-700 dark:text-gray-300">Unlimited Resume Analyses</span>
                                </div>
                            </div>
                        </div>
                    </div>
